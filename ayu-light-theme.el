...
(custom-theme-set-faces
 'ayu-light
 '(default ((t (:slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#5a6c75" :background "#eff5f8" :stipple nil :inherit nil))))
